...
////////////////////////////////get State Dali Bus/////////////////////////////////////////////////
    ...
    responseState (level, address, bus){
        ...
        if(address.indexOf('a')===0){
            ...
            this.adapter.setState(this.adapter.namespace + '.' + 'bus'+ bus + '.lamps.' + address, level, true)
            this.adapter.log.debug('neu ' + address + (level))
        } else {
            
            this.adapter.setState(this.adapter.namespace + '.' + 'bus'+ bus + '.groups.' + address, level, true)
            this.adapter.log.debug('neu ' + address + (level))
        }
    }
